            ...
            <tbody>
              {loadingR ? (
                ...
                <tr key={r.worker_id}>
                  ...
                  <td className="text-right font-mono tabular-nums font-bold" style={{ color: '#FB923C' }}>{fmtCLP(r.total)}</td>
                </tr>
              ))}
            </tbody>
            {rows.length > 0 && (
              <tfoot>
                <tr className="border-t-2 border-slate-300 bg-slate-50/60">
                  ...
                  <td className="text-right font-mono tabular-nums font-bold" style={{ color: '#FB923C' }}>{fmtCLP(totals.total)}</td>
                </tr>
              </tfoot>
            )}
          </table>
