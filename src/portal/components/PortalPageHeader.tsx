...
export default function PortalPageHeader({ eyebrow, title, subtitle, notifications = 0, right }: Props) {
  ...
  return (
    <header
      className="p-fade-up relative overflow-hidden rounded-2xl px-6 sm:px-8 py-7 sm:py-8 text-white"
    ...
    >
      ...
      <div className="relative flex items-start justify-between flex-wrap gap-4">
        <div className="min-w-0">
          {eyebrow && (
            <p className="text-[11px] uppercase tracking-widest text-white/65 font-semibold">{eyebrow}</p>
          )}
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="relative w-10 h-10 rounded-xl bg-white/10 backdrop-blur border border-white/15 flex items-center justify-center hover:bg-white/15 transition-colors"
          >
          ...
          <div
            className="w-10 h-10 rounded-full flex items-center justify-center font-semibold text-sm border border-white/25"
