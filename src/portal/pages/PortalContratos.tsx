    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      {venc30.length > 0 && (
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #EA580C 0%, #f43f5e 100%)' }}
            ...
            <tbody>
              {(kpis?.masa_por_sucursal ?? []).length === 0 ? (
                ...
                >
                  ...
                  <td className="text-right font-mono tabular-nums font-bold" style={{ color: '#FB923C' }}>{fmtCLP(r.total_liquid)}</td>
