...
export const INITIAL_PIPELINE: PipelineEntry[] = [
  { vacanteId: 1, candidatoId: 101, etapa: 'Entrevista' },
  { vacanteId: 1, candidatoId: 103, etapa: 'Screening' },
  { vacanteId: 1, candidatoId: 105, etapa: 'Finalista' },
  { vacanteId: 2, candidatoId: 102, etapa: 'Postuló' },
  { vacanteId: 3, candidatoId: 104, etapa: 'Presentado' },
];

export const PIPELINE_STAGES = ['Postuló', 'Screening', 'Entrevista', 'Finalista', 'Presentado', 'Contratado'] as const;

export type PipelineStage = typeof PIPELINE_STAGES[number];

export const STAGE_COLORS: Record<PipelineStage, { bg: string; border: string; text: string; dot: string }> = {
  'Postuló': { bg: 'hsl(var(--kanban-postulo))', border: 'hsl(var(--kanban-postulo-border))', text: 'hsl(var(--kanban-postulo-text))', dot: 'hsl(var(--kanban-postulo-dot))' },
  'Screening': { bg: 'hsl(var(--kanban-screening))', border: 'hsl(var(--kanban-screening-border))', text: 'hsl(var(--kanban-screening-text))', dot: 'hsl(var(--kanban-screening-dot))' },
  'Entrevista': { bg: 'hsl(var(--kanban-entrevista))', border: 'hsl(var(--kanban-entrevista-border))', text: 'hsl(var(--kanban-entrevista-text))', dot: 'hsl(var(--kanban-entrevista-dot))' },
  ...
  'Presentado': { bg: 'hsl(var(--kanban-presentado))', border: 'hsl(var(--kanban-presentado-border))', text: 'hsl(var(--kanban-presentado-text))', dot: 'hsl(var(--kanban-presentado-dot))' },
